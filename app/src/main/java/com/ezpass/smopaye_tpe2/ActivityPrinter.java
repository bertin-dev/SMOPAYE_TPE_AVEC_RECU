                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Bitmap bitmap1= BitmapFactory.decodeResource(ActivityPrinter.this.getResources(),R.mipmap.logo_smopaye);
                            ...
                            usbThermalPrinter.addString("La  monaie du future\n");
                            usbThermalPrinter.setAlgin(UsbThermalPrinter.ALGIN_LEFT);
                            usbThermalPrinter.setTextSize(24);
                            usbThermalPrinter.addString("MERCHANT NAME:             Smopaye");
                            usbThermalPrinter.addString("MERCHANT NO:                  0dfertr1");
                            ...
                            usbThermalPrinter.walkPaper(10);
                                ...
                                e.printStackTrace();
                                Result = e.toString();
                                if (Result.equals("com.telpoe.tps550.api.printer.NoPaperException")) {
                                    handler.sendMessage(handler.obtainMessage(NOPAPER, 1, 0, null));
                                } else if (Result.equals("com.telpoe.tps550.api.printer.OverHeatException")) {
