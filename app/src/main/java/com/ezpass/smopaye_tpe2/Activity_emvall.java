...
import com.ezpass.smopaye_tpe2.dialog.DialogListener;
import com.ezpass.smopaye_tpe2.dialog.TelpoProgressDialog;
import com.ezpass.smopaye_tpe2.dialog.WritePadDialog;
...
public class Activity_emvall extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("telpoe", "PinpadService deviceOpen open:" + ret);
        if(ret != 0){
                            ...
                            if (ret == EmvService.QPBOC_ARQC) {
                                ...
                                if ( ret == PinpadService.PIN_ERROR_CANCEL){
                                    ...
                                    try {
                                        ...
                                        usbThermalPrinter.setTextSize(24);
                                        usbThermalPrinter.addString("MERCHANT NAME:             SMOPAYE");
                                        usbThermalPrinter.addString("MERCHANT NO:                  ");
                                        usbThermalPrinter.addString("TERMINAL NO:                  02");
                                        int i = usbThermalPrinter.measureText("CARD NO:" + cardNum);
                                        int i1 = usbThermalPrinter.measureText(" ");
                                        int SpaceNumber=(384-i)/i1;
