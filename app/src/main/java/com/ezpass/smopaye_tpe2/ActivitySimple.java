...
//        sDesKey = "498C189C17F5E37750B55FE757865000";     //用主密钥加密后的des加密密钥
        ...
        Log.d("telpoe", "PinpadService deviceOpen open:" + i);
    ...
    protected void onDestroy() {
        ...
        Log.d("telpoe", "Device close: " + i);
        PinpadService.Close();
        Log.d("telpoe", "Device close");
    }
