...
public class ncf_formulaire extends Activity {
    private final String TAG = "ncf_formulaire";
    ...
    private EditText dat = null;
    private EditText tel = null;
    private EditText cni = null;
    private EditText numcarte = null;
    private EditText numcarte2 = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nfc_formulaire);
...
/*
        ...
        dat = (EditText) findViewById(R.id.datenaiss);
        cni = (EditText) findViewById(R.id.cni);
        tel = (EditText) findViewById(R.id.tel);
        numcarte = (EditText) findViewById(R.id.numCarte);
        numcarte2 = (EditText) findViewById(R.id.numCarte2);
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case CHECK_NFC_TIMEOUT: {
                        Toast.makeText(ncf_formulaire.this, "Check card time out!", Toast.LENGTH_LONG).show();
                        open_btn.setEnabled(true);
                        close_btn.setEnabled(false);
                        check_btn.setEnabled(false);
                    }break;
                    case SHOW_NFC_DATA:{
                        ...
                        if (uid_data[0] == 0x42) {
                            // TYPE B类（暂时只支持cpu卡）type 	Classe B (temporaire ne supporte que les cartes CPU)
                           ...
                           // numcarte.setText( getString(R.string.uid_data) + StringUtil.toHexString(uid));
                           // numcarte2.setText( getString(R.string.uid_data) + StringUtil.toHexString(uid));
    ...
    public void sendAPDUData() {
        ...
        if (!TextUtils.isEmpty(StringUtil.toHexString(result))) {
            Toast.makeText(ncf_formulaire.this,
